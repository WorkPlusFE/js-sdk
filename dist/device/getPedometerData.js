...
function getPedometerData(options) {
    return core.exec(constants_1.WORKPLUS_DEVICE, 'getPedometerData', [], options === null || options === void 0 ? void 0 : options.success, options === null || options === void 0 ? void 0 : options.fail);
}
