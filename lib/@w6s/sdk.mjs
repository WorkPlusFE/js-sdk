...
var SDK = /** @class */ (function () {
    ...
    SDK.sendEvent = function (service, action, data, successFn, failedFn) {
...
function selectImages(options) {
    var _a, _b, _c;
    return SDK.sendEvent(ServiceKey, 'selectImages', [{ imageKeys: (_a = options) === null || _a === void 0 ? void 0 : _a.imageKeys }], (_b = options) === null || _b === void 0 ? void 0 : _b.success, (_c = options) === null || _c === void 0 ? void 0 : _c.fail);
}
/**
 * 清除压缩后的图片
...
function showImages(options) {
    var _a, _b, _c, _d;
    return SDK.sendEvent(ServiceKey, 'showImages', (_b = (_a = options) === null || _a === void 0 ? void 0 : _a.data, (_b !== null && _b !== void 0 ? _b : [])), (_c = options) === null || _c === void 0 ? void 0 : _c.success, (_d = options) === null || _d === void 0 ? void 0 : _d.fail);
}
/**
 * 保存图片
...
function saveImages(options) {
    var _a, _b, _c, _d;
    return SDK.sendEvent(ServiceKey, 'saveImages', (_b = (_a = options) === null || _a === void 0 ? void 0 : _a.data, (_b !== null && _b !== void 0 ? _b : [])), (_c = options) === null || _c === void 0 ? void 0 : _c.success, (_d = options) === null || _d === void 0 ? void 0 : _d.fail);
}
/**
 * 长按图片弹出框
...
function actionForLongPressImage(options) {
    var _a, _b, _c, _d;
    return SDK.sendEvent(ServiceKey, 'actionForLongPressImage', (_b = (_a = options) === null || _a === void 0 ? void 0 : _a.data, (_b !== null && _b !== void 0 ? _b : [])), (_c = options) === null || _c === void 0 ? void 0 : _c.success, (_d = options) === null || _d === void 0 ? void 0 : _d.fail);
}
/**
...
function takePicture(options) {
    var _a, _b, _c, _d;
    return SDK.sendEvent(ServiceKey, 'takePicture', (_b = (_a = options) === null || _a === void 0 ? void 0 : _a.data, (_b !== null && _b !== void 0 ? _b : [])), (_c = options) === null || _c === void 0 ? void 0 : _c.success, (_d = options) === null || _d === void 0 ? void 0 : _d.fail);
}
/**
...
function chooseImages(options) {
    var _a, _b, _c, _d;
    return SDK.sendEvent(ServiceKey, 'chooseImages', (_b = (_a = options) === null || _a === void 0 ? void 0 : _a.data, (_b !== null && _b !== void 0 ? _b : [])), (_c = options) === null || _c === void 0 ? void 0 : _c.success, (_d = options) === null || _d === void 0 ? void 0 : _d.fail);
}
/**
...
function takePictureAddWatermark(options) {
    var _a, _b, _c, _d;
    return SDK.sendEvent(ServiceKey, 'takePictureAddWatermark', (_b = (_a = options) === null || _a === void 0 ? void 0 : _a.data, (_b !== null && _b !== void 0 ? _b : [])), (_c = options) === null || _c === void 0 ? void 0 : _c.success, (_d = options) === null || _d === void 0 ? void 0 : _d.fail);
}
...
export { Storage, image, native, utils, version };
